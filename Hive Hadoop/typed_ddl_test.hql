--TABLES ARE ALL CREATED ON April 17
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_gngnco ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_actran ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_acpos  ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_esmgr  ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_gncode ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_gnexch ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfacct ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfbr   ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfcl   ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfclac ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfclcl ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfrr   ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfrrus ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_mfsc   ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_tpcont ;
DROP TABLE IF EXISTS inv_aum_raw_qa.test_dpl_tpkptl ;
...
CREATE TABLE inv_aum_raw_qa.test_dpl_actran (
  stl_dt DATE
, last_time STRING
, acct STRING
, last_dt DATE
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_actran/';


CREATE TABLE inv_aum_raw_qa.test_dpl_acpos (
  acct STRING
, cusip STRING
, rr STRING
...
COMMENT 'Data from acpos'
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_acpos/';

CREATE TABLE inv_aum_raw_qa.test_dpl_esmgr (
  fund_code STRING
, fund_type STRING
, trd_acct STRING
, box_acct STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_esmgr/';

CREATE TABLE inv_aum_raw_qa.test_dpl_gncode (
  code STRING
, code_value STRING
, last_dt DATE
, descr STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_gncode/';

CREATE TABLE inv_aum_raw_qa.test_dpl_gnexch (
  rate DECIMAL(23,8)
, buy_fds STRING
, sell_fds STRING
, tran_type STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_gnexch/';

CREATE TABLE inv_aum_raw_qa.test_dpl_mfacct (
  acct STRING
, fund_type STRING
, last_dt DATE
, last_time STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfacct/';


CREATE TABLE inv_aum_raw_qa.test_dpl_mfbr (
  branch STRING
, last_dt DATE
, last_time STRING
, last_usr STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfbr/';


CREATE TABLE inv_aum_raw_qa.test_dpl_mfcl (
  client INT
, sps_sin STRING
, first_name STRING
, last_name STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfcl/';


CREATE TABLE inv_aum_raw_qa.test_dpl_mfclac (
  acct STRING
, stat STRING
, del_code STRING
, comm_type STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfclac/';

CREATE TABLE inv_aum_raw_qa.test_dpl_mfclcl (
  class STRING
, descr STRING
, cl_type STRING
, last_dt DATE
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfclcl/';

CREATE TABLE inv_aum_raw_qa.test_dpl_mfrr (
  rr STRING
, last_name STRING
, first_name STRING
, addr1 STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfrr/';

CREATE TABLE inv_aum_raw_qa.test_dpl_mfrrus (
  usr STRING
, rr STRING
, last_dt DATE
, last_time STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfrrus/';

CREATE TABLE inv_aum_raw_qa.test_dpl_mfsc (
  cusip STRING
, short_name STRING
, symbol STRING
, sec_code STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_mfsc/';

CREATE TABLE inv_aum_raw_qa.test_dpl_tpcont (
  acct STRING
, fill_prc_int STRING
, fill_qty STRING
, principal STRING
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_tpcont/';

CREATE TABLE inv_aum_raw_qa.test_dpl_tpkptl (
  proc_dt DATE
, trd_num INT
, last_dt DATE
, tlr_num INT
...
PARTITIONED BY (process_date DATE)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' WITH SERDEPROPERTIES ("field.delim" = "\u0001")
LOCATION '/apps/inv_qa/aum/raw/qa_test/dataphile/16_tables/test_dpl_tpkptl/';
