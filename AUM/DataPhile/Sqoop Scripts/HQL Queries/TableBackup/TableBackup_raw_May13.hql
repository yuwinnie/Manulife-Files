...
create table inv_aum_raw_qa.20200513_bkp_test_dpl_actran like inv_aum_raw_qa.test_dpl_actran;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_gngnco like inv_aum_raw_qa.test_dpl_gngnco;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfclac like inv_aum_raw_qa.test_dpl_mfclac;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfacct like inv_aum_raw_qa.test_dpl_mfacct;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfrr   like inv_aum_raw_qa.test_dpl_mfrr;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_esmgr  like inv_aum_raw_qa.test_dpl_esmgr;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_acpos  like inv_aum_raw_qa.test_dpl_acpos;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_gnexch like inv_aum_raw_qa.test_dpl_gnexch;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_tpkptl like inv_aum_raw_qa.test_dpl_tpkptl;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfclcl like inv_aum_raw_qa.test_dpl_mfclcl;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfsc   like inv_aum_raw_qa.test_dpl_mfsc;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_tpcont like inv_aum_raw_qa.test_dpl_tpcont;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfbr   like inv_aum_raw_qa.test_dpl_mfbr;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfcl   like inv_aum_raw_qa.test_dpl_mfcl;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_mfrrus like inv_aum_raw_qa.test_dpl_mfrrus;
create table inv_aum_raw_qa.20200513_bkp_test_dpl_gncode like inv_aum_raw_qa.test_dpl_gncode;



insert into inv_aum_raw_qa.20200513_bkp_test_dpl_actran partition(process_date) select * from inv_aum_raw_qa.test_dpl_actran;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_gngnco partition(process_date) select * from inv_aum_raw_qa.test_dpl_gngnco;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfclac partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfclac;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfacct partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfacct;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfrr   partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfrr;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_esmgr  partition(process_date) select * from inv_aum_raw_qa.test_dpl_esmgr;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_acpos  partition(process_date) select * from inv_aum_raw_qa.test_dpl_acpos;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_gnexch partition(process_date) select * from inv_aum_raw_qa.test_dpl_gnexch;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_tpkptl partition(process_date) select * from inv_aum_raw_qa.test_dpl_tpkptl;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfclcl partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfclcl;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfsc   partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfsc;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_tpcont partition(process_date) select * from inv_aum_raw_qa.test_dpl_tpcont;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfbr   partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfbr;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfcl   partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfcl;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_mfrrus partition(process_date) select * from inv_aum_raw_qa.test_dpl_mfrrus;
insert into inv_aum_raw_qa.20200513_bkp_test_dpl_gncode partition(process_date) select * from inv_aum_raw_qa.test_dpl_gncode;
...
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_actran) as t,
...
select  '02_dpl_gngnco' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_gngnco) as t,
...
select  '03_dpl_mfclac' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfclac) as t,
...
select  '04_dpl_mfacct' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfacct) as t,
...
select  '05_dpl_mfrr' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfrr) as t,
...
select  '06_dpl_esmgr' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_esmgr) as t,
...
select  '07_dpl_acpos' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_acpos) as t,
...
select  '08_dpl_gnexch' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_gnexch) as t,
...
select  '09_dpl_tpkptl' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_tpkptl) as t,
...
select  '10_dpl_mfclcl' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfclcl) as t,
...
select  '11_dpl_mfsc' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfsc) as t,
...
select  '12_dpl_tpcont' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_tpcont) as t,
...
select  '13_dpl_mfbr' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfbr) as t,
...
select  '14_dpl_mfcl' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfcl) as t,
...
select  '15_dpl_mfrrus' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_mfrrus) as t,
...
select  '16_dpl_gncode' as tableName, t.cn  as  backup_rc, o.cn  as  original_cn,
        case when t.cn = o.cn then 'PASS' else 'FAIL' end as result
from    (select count(*) as cn from inv_aum_raw_qa.20200513_bkp_test_dpl_gncode) as t,
        (select count(*) as cn from inv_aum_raw_qa.test_dpl_gncode) as o;
+----------------+---------------+-----------------+------------+--+
|  u1.tablename  | u1.backup_rc  | u1.original_cn  | u1.result  |
+----------------+---------------+-----------------+------------+--+
| 01_dpl_actran  | 84061289      | 84061289        | PASS       |
| 10_dpl_mfclcl  | 188           | 188             | PASS       |
| 11_dpl_mfsc    | 4342416       | 4342416         | PASS       |
| 12_dpl_tpcont  | 10429922      | 10429922        | PASS       |
| 13_dpl_mfbr    | 3282          | 3282            | PASS       |
| 14_dpl_mfcl    | 2608463       | 2608463         | PASS       |
| 15_dpl_mfrrus  | 34322         | 34322           | PASS       |
| 16_dpl_gncode  | 2257836       | 2257836         | PASS       |
| 02_dpl_gngnco  | 8             | 8               | PASS       |
| 03_dpl_mfclac  | 4069981       | 4069981         | PASS       |
| 04_dpl_mfacct  | 656           | 656             | PASS       |
| 05_dpl_mfrr    | 40802         | 40802           | PASS       |
| 06_dpl_esmgr   | 2034          | 2034            | PASS       |
| 07_dpl_acpos   | 3568073       | 3568073         | PASS       |
| 08_dpl_gnexch  | 1386          | 1386            | PASS       |
| 09_dpl_tpkptl  | 20033705      | 20033705        | PASS       |
+----------------+---------------+-----------------+------------+--+
16 rows selected (34.538 seconds)
