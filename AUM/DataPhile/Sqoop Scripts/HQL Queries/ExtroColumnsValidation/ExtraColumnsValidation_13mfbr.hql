...
select  branch,broker_code, process_date, process_timestamp
from    inv_aum_typed_qa.dpl_mfbr where process_date = cast(regexp_replace(${t_process_date},'(\\d{4})(\\d{2})(\\d{2})','$1-$2-$3') as date) 
