DROP TABLE IF EXISTS inv_aum_typed.dpl_gngnco ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_actran ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_acpos  ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_esmgr  ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_gncode ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_gnexch ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfacct ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfbr   ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfcl   ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfclac ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfclcl ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfrr   ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfrrus ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_mfsc   ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_tpcont ;
DROP TABLE IF EXISTS inv_aum_typed.dpl_tpkptl ;


CREATE TABLE inv_aum_typed.dpl_gngnco (addr STRING
, city STRING
, pc STRING
, ph STRING
, prov STRING
...
CREATE TABLE inv_aum_typed.dpl_actran (stl_dt DATE
, last_time STRING
, acct STRING
, last_dt DATE
, proc_dt DATE
...
CREATE TABLE inv_aum_typed.dpl_acpos (acct STRING
, cusip STRING
, rr STRING
...
CREATE TABLE inv_aum_typed.dpl_esmgr (fund_code STRING
, fund_type STRING
, trd_acct STRING
, box_acct STRING
, last_dt DATE
...
CREATE TABLE inv_aum_typed.dpl_gncode (code STRING
, code_value STRING
, last_dt DATE
, descr STRING
, subsystem STRING
...
CREATE TABLE inv_aum_typed.dpl_gnexch (rate DECIMAL(23,8)
, buy_fds STRING
, sell_fds STRING
, tran_type STRING
, exch_dt DATE
...
CREATE TABLE inv_aum_typed.dpl_mfacct (acct STRING
, fund_type STRING
, last_dt DATE
, last_time STRING
, last_usr STRING
...
CREATE TABLE inv_aum_typed.dpl_mfbr (branch STRING
, last_dt DATE
, last_time STRING
, last_usr STRING
, short_name STRING
...
CREATE TABLE inv_aum_typed.dpl_mfcl (client INT
, rr STRING
, residence STRING
, nrt STRING
, stat STRING
...
CREATE TABLE inv_aum_typed.dpl_mfclac (acct STRING
, stat STRING
, del_code STRING
, comm_type STRING
...
CREATE TABLE inv_aum_typed.dpl_mfclcl (class STRING
, descr STRING
, cl_type STRING
, last_dt DATE
, last_time STRING
...
CREATE TABLE inv_aum_typed.dpl_mfrr (rr STRING
, last_name STRING
, first_name STRING
, addr1 STRING
, addr2 STRING
...
CREATE TABLE inv_aum_typed.dpl_mfrrus (usr STRING
, rr STRING
, last_dt DATE
, last_time STRING
, last_usr STRING
...
CREATE TABLE inv_aum_typed.dpl_mfsc (cusip STRING
, short_name STRING
, symbol STRING
, sec_code STRING
, port_sort STRING
...
CREATE TABLE inv_aum_typed.dpl_tpcont (acct STRING
, fill_prc_int STRING
, fill_qty STRING
, principal STRING
, mkt_code STRING
...
CREATE TABLE inv_aum_typed.dpl_tpkptl (proc_dt DATE
, trd_num INT
, last_dt DATE
, tlr_num INT
, tlr_text STRING
